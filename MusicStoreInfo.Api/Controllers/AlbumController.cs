...
namespace MusicStoreInfo.Api.Controllers
{
    ...
    public class AlbumController : Controller
    {
        ...
        //TODO: Добавить рейтинг и отзывы()
        //TODO: Добавить возможность покупки и формирования заказа
        ...
        //TODO: Создавать админа, если его нет(+)
        //TODO: Сделать пагинацию и фильтрацию для всех справочников(+)
        //TODO: Сделать, чтобы менеджер видел только свои продукты(+)
        //TODO: При обновлении данных пользователей(смена ролей) делать обновление и в системных таблицах(+)
