...
namespace MusicStoreInfo.DAL.Migrations
{
    ...
    [Migration("20240430101140_Added ShoppingCart")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductShoppingCart", b =>
                {
                    ...
                    b.Property<int>("ProductsAlbumId")
                        .HasColumnType("int");

                    b.HasKey("ShoppingCartsId", "ProductsStoreId", "ProductsAlbumId");

                    b.HasIndex("ProductsStoreId", "ProductsAlbumId");

                    b.ToTable("ShoppingCartProductLink", (string)null);
                });
            ...
            modelBuilder.Entity("ProductShoppingCart", b =>
                {
                    b.HasOne("MusicStoreInfo.Domain.Entities.ShoppingCart", null)
                        .WithMany()
                        .HasForeignKey("ShoppingCartsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MusicStoreInfo.Domain.Entities.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductsStoreId", "ProductsAlbumId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
